...
<div class="col-md-12 panel">
	...
	<div class="col-md-12 panel-body" style="padding-bottom:30px;">
		<div class="col-md-12">
			<form class="cmxform" id="signupForm" method="post" enctype="multipart/form-data" action="/divisi/{{ Crypt::encrypt($divisi->id) }}" autocomplete="off">
			...
			<div class="col-md-12">
				...
				<div class="form-group form-animate-text @if($errors->has('nama_divisi')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('nama_divisi')) error @endif" id="nama_divisi" name="nama_divisi" required="" aria-required="true" value="{{ $divisi->name }}">
					<span class="bar"></span>
