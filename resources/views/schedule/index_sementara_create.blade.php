...
<div class="col-md-12 panel">
	...
	<h4>Form Jadwal Sementara</h4>
	</div>
	<div class="col-md-12 panel-body" style="padding-bottom:30px;">
		<div class="col-md-12">
			<form class="cmxform" id="divisiForm" method="post" enctype="multipart/form-data" action="/jadwal-sementara" autocomplete="off">
			 @csrf
			<div class="col-md-12">
				...
				<div class="form-group form-animate-text @if($errors->has('kode_pelanggan')) form-animate-error @endif" style="margin-top:40px !important;">
					...
					@foreach ($customers as $d)
						<option value="{{$d->id}}" @if(old('kode_pelanggan') == $d->id) selected="selected" @endif>{{$d->name.' / '.$d->code}}</option>
					@endforeach
				...
				<div class="form-group form-animate-text @if($errors->has('tipe_pelayanan')) form-animate-error @endif" style="margin-top:40px !important;">
					...
					<option value="datang langsung" @if(old('tipe_pelayanan') =='datang langsung') selected="selected" @endif>Datang Langsung</option>
                    <option value="melalui telpon" @if(old('tipe_pelayanan') == 'melalui telpon') selected="selected" @endif>Melalui Telpon</option>
					</select>
					<span class="bar"></span>
