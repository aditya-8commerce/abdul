...
<div class="col-md-12 padding-0">
        <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List Jadwal Proses</h3></div>
                    <div class="panel-body">
                      <div class="responsive-table">
                      <div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row">
					  <div class="col-sm-12">
					  <form class="cmxform" method="get" action="/jadwal-proses" novalidate="novalidate">
					  ...
					  <a href="/jadwal-proses"><input class="submit btn btn-danger" type="button" value="Reset"></a>
					...
					@endphp
                      <tr>
							...
							<td>
                                <a href="/jadwal-proses/{{ Crypt::encrypt($d->id) }}"><input class="submit btn btn-primary" type="button" value="Detail Data"></a>
