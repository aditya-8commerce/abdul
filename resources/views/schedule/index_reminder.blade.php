...
<div class="col-md-12 padding-0">
        <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>List Jadwal Reminder</h3></div>
                    <div class="panel-body">
                      <div class="responsive-table">
                      <div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row">
					  <div class="col-sm-12">
					  <form class="cmxform" method="get" action="/jadwal-reminder" novalidate="novalidate">
                      ...
                      <a href="/jadwal-reminder"><input class="submit btn btn-danger" type="button" value="Reset"></a>
                    </label>
					  </div>
					  </form>
					  </div>
					...
					@endphp
                      <tr>
                            ...
                            <td>{{$d->date_finish}}</td>
                            <td>{{$hours}}</td>
                            <td>{{$d->reminder_service}} Bulan</td>
                            <td>
								@if(isset($d->users))
							...
							<td>
								<a href="/jadwal-reminder/{{ Crypt::encrypt($d->id) }}"><input class="submit btn btn-primary" type="button" value="Detail Data"></a>
							</td>
                      </tr>
                    @endforeach
                    @endif
