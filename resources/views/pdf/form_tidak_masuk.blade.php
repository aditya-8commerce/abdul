<html>
 ...
 <table border="0" width="100%" style="padding:0;">
    ...
    <tr>
        <td colspan="10" align="center"><h1 align="center">FORM TIDAK MASUK KERJA</h1></td>
    </tr>
    ...
    <tr>
        <td colspan="4" align="left"><h3 align="right">TANGGAL FORM</h3></td>
        <td align="center"><h3 align="center">:</h3></td>
        <td colspan="5" align="left"><h3 align="left">{{$data->created_at}}</h3></td>
    </tr>
    ...
    <tr>
        <td colspan="5" align="left"><h3 align="left">KATEGORI IJIN : <br>{{$data->reason}}</h3></td>
    ...
    <tr>
        <td colspan="10" align="left"><h3 align="left">POTONGAN : <br>{{$data->piece}}</h3></td>
    </tr>
