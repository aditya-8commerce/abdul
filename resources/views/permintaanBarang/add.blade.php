...
<div class="col-md-12 panel">
	...
	<div class="col-md-12 panel-body" style="padding-bottom:30px;">
		<div class="col-md-12">
			<form class="cmxform" id="signupForm" method="post" enctype="multipart/form-data" action="/permintaan-barang" autocomplete="off">
			 @csrf
			<div class="col-md-12">
			@if(strtolower(Auth::user()->divisi->name) == 'administrator' &&  strtolower(Auth::user()->posisi->name) == 'administrator')
				...
				<div class="form-group form-animate-text @if($errors->has('nama_proyek')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('nama_proyek')) error @endif" id="nama_proyek" name="nama_proyek" required="" aria-required="true" value="{{ old('nama_proyek') }}">
					<span class="bar"></span>
...
<br><br>        
				...
				<div class="form-group form-animate-text @if($errors->has('bukti')) form-animate-error @endif" style="margin-top:40px !important;">
					...
					<input type="file" class="form-text @if($errors->has('bukti')) error @endif" id="bukti" name="bukti" multiple accept="image/*" required="" aria-required="true">
				</div>
