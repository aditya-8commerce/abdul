...
<tr>
    ...
    <textarea class="form-control issue @if($errors->has('issue')) error @endif"  id="issue" name="issue">{{ old('issue') }}</textarea>
    ...
    <textarea class="form-control action @if($errors->has('action')) error @endif"  id="action" name="action">{{ old('action') }}</textarea>
    ...
    <textarea class="form-control recommendation @if($errors->has('recommendation')) error @endif"  id="recommendation" name="recommendation">{{ old('recommendation') }}</textarea>
