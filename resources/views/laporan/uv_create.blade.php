...
<tr>
    ...
    <input type="text" class="form-control mfg @if($errors->has('mfg')) error @endif" data-date-format="yyyy-mm-dd" id="mfg" name="mfg" value="{{ old('mfg') }}">
    @if($errors->has('mfg'))  <em class="error">{{ $errors->first('mfg') }}</em> @endif
</td>
    <td colspan="4" style="text-align: left;">Running Hours : <br> 
    <input type="number" step="any" class="form-control running_hours @if($errors->has('running_hours')) error @endif"  id="running_hours" name="running_hours" value="{{ old('running_hours') }}">
...
<tr>
    ...
    <input type="text" class="form-control line @if($errors->has('line')) error @endif" id="line" name="line" value="{{ old('line') }}">
...
<tr>
    ...
    <input type="text" class="form-control voltage_input @if($errors->has('voltage_input')) error @endif" id="voltage_input " name="voltage_input" value="{{ old('voltage_input') }}">
    @if($errors->has('voltage_input'))  <em class="error">{{ $errors->first('voltage_input') }}</em> @endif 
    </td>
    <td colspan="2" rowspan="20" style="text-align: left;"><textarea class="form-control reccomendation @if($errors->has('reccomendation')) error @endif" id="reccomendation " name="reccomendation">{{ old('reccomendation') }}</textarea> </td>
</tr>
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">Volt </td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control output_ballast_1 @if($errors->has('output_ballast_1')) error @endif" id="output_ballast_1 " name="output_ballast_1" value="{{ old('output_ballast_1') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">Volt </td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control output_ballast_2 @if($errors->has('output_ballast_2')) error @endif" id="output_ballast_2 " name="output_ballast_2" value="{{ old('output_ballast_2') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">Volt </td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control output_ballast_3 @if($errors->has('output_ballast_3')) error @endif" id="output_ballast_3 " name="output_ballast_3" value="{{ old('output_ballast_3') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">Volt </td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control output_ballast_4 @if($errors->has('output_ballast_4')) error @endif" id="output_ballast_4 " name="output_ballast_4" value="{{ old('output_ballast_4') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control frequency @if($errors->has('frequency')) error @endif" id="frequency " name="frequency" value="{{ old('frequency') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">% </td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control monitoring_station @if($errors->has('monitoring_station')) error @endif" id="monitoring_station " name="monitoring_station" value="{{ old('monitoring_station') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control tempreature @if($errors->has('tempreature')) error @endif" id="tempreature " name="tempreature" value="{{ old('tempreature') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;"></td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control cable_sensor @if($errors->has('cable_sensor')) error @endif" id="cable_sensor " name="cable_sensor" value="{{ old('cable_sensor') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;"></td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control sensor_uv @if($errors->has('sensor_uv')) error @endif" id="sensor_uv " name="sensor_uv" value="{{ old('sensor_uv') }}">
...
<tr>
    ...
    <td colspan="2" style="text-align: left;"></td>
    <td colspan="2" style="text-align: left;">
    <input type="text" class="form-control lamp_uv @if($errors->has('lamp_uv')) error @endif" id="lamp_uv " name="lamp_uv" value="{{ old('lamp_uv') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;"></td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control indicator_lamp @if($errors->has('indicator_lamp')) error @endif" id="indicator_lamp" name="indicator_lamp" value="{{ old('indicator_lamp') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;"></td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control noise_filter @if($errors->has('noise_filter')) error @endif" id="noise_filter" name="noise_filter" value="{{ old('noise_filter') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;"></td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control compression_nut @if($errors->has('compression_nut')) error @endif" id="compression_nut" name="compression_nut" value="{{ old('compression_nut') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;"></td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control o_ring  @if($errors->has('o_ring')) error @endif" id="o_ring" name="o_ring" value="{{ old('o_ring') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control supply_voltage_to_detector  @if($errors->has('supply_voltage_to_detector')) error @endif" id="supply_voltage_to_detector" name="supply_voltage_to_detector" value="{{ old('supply_voltage_to_detector') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;">V. DC</td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control voltage_uv_output  @if($errors->has('voltage_uv_output')) error @endif" id="voltage_uv_output" name="voltage_uv_output" value="{{ old('voltage_uv_output') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;">V. DC</td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control voltage_temperature  @if($errors->has('voltage_temperature')) error @endif" id="voltage_temperature" name="voltage_temperature" value="{{ old('voltage_temperature') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;"> </td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control main_switch  @if($errors->has('main_switch')) error @endif" id="main_switch" name="main_switch" value="{{ old('main_switch') }}">
 ...
 <tr>
     ...
     <td colspan="2" style="text-align: left;"> </td>
     <td colspan="2" style="text-align: left;">
     <input type="text" class="form-control fan_uv  @if($errors->has('fan_uv')) error @endif" id="fan_uv" name="fan_uv" value="{{ old('fan_uv') }}">
...
<tr>
    ...
    <textarea class="form-control remarks @if($errors->has('remarks')) error @endif" id="remarks " name="remarks" style="width: 100%;">{{ old('remarks') }}</textarea>
    </td>
</tr>
