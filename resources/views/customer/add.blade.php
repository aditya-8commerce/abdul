...
<div class="col-md-12 panel">
	...
	<div class="col-md-12 panel-body" style="padding-bottom:30px;">
		<div class="col-md-12">
			<form class="cmxform" id="signupForm" method="post" enctype="multipart/form-data" action="/pelanggan" autocomplete="off">
			 @csrf
			<div class="col-md-12">
            ...
            <div class="form-group form-animate-text @if($errors->has('kode_pelanggan')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('kode_pelanggan')) error @endif" id="kode_pelanggan" name="kode_pelanggan" required="" aria-required="true" value="{{ old('kode_pelanggan') }}">
					<span class="bar"></span>
            ...
            <div class="form-group form-animate-text @if($errors->has('nama_pelanggan')) form-animate-error @endif" style="margin-top:40px !important;">
                <input type="text" class="form-text @if($errors->has('nama_pelanggan')) error @endif" id="nama_pelanggan" name="nama_pelanggan" required="" aria-required="true" value="{{ old('nama_pelanggan') }}">
                <span class="bar"></span>
            ...
            <div class="form-group form-animate-text @if($errors->has('email_pelanggan')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="email" class="form-text @if($errors->has('email_pelanggan')) error @endif" id="email_pelanggan" name="email_pelanggan" required="" aria-required="true" value="{{ old('email_pelanggan') }}">
					<span class="bar"></span>
                    <label>Email</label>
            ...
            <div class="form-group form-animate-text @if($errors->has('telepon_pelanggan')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('telepon_pelanggan')) error @endif" id="telepon_pelanggan" name="telepon_pelanggan" required="" aria-required="true" pattern="\+?([ -]?\d+)+|\(\d+\)([ -]\d+)" maxlength="20" value="{{ old('telepon_pelanggan') }}"  title="Masukan no telpon / handtelepon_pelanggan dengan benar">
					<span class="bar"></span>
					<label>Telepon</label>
				...
				<div class="form-group form-animate-text @if($errors->has('alamat_pelanggan')) form-animate-error @endif" style="margin-top:40px !important;">
					<textarea class="form-text @if($errors->has('alamat_pelanggan')) error @endif" id="alamat_pelanggan" name="alamat_pelanggan" required="" aria-required="true">{{ old('alamat_pelanggan') }}</textarea>
					<span class="bar"></span>
					<label>Alamat</label>
