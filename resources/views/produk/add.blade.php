...
<div class="col-md-12 panel">
	...
	<div class="col-md-12 panel-body" style="padding-bottom:30px;">
		<div class="col-md-12">
			<form class="cmxform" id="signupForm" method="post" enctype="multipart/form-data" action="/produk" autocomplete="off">
			 @csrf
			<div class="col-md-12">
            ...
            <div class="form-group form-animate-text @if($errors->has('kode_produk')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('kode_produk')) error @endif" id="kode_produk" name="kode_produk" required="" aria-required="true" value="{{ old('kode_produk') }}">
					<span class="bar"></span>
            ...
            <div class="form-group form-animate-text @if($errors->has('nama_produk')) form-animate-error @endif" style="margin-top:40px !important;">
                <input type="text" class="form-text @if($errors->has('nama_produk')) error @endif" id="nama_produk" name="nama_produk" required="" aria-required="true" value="{{ old('nama_produk') }}">
                <span class="bar"></span>
            ...
            <div class="form-group form-animate-text @if($errors->has('brand')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('brand')) error @endif" id="brand" name="brand" required="" aria-required="true" value="{{ old('brand') }}">
					<span class="bar"></span>
					<label>Brand</label>
            ...
            <div class="form-group form-animate-text @if($errors->has('model')) form-animate-error @endif" style="margin-top:40px !important;">
					<input type="text" class="form-text @if($errors->has('model')) error @endif" id="model" name="model" required="" aria-required="true" value="{{ old('model') }}">
					<span class="bar"></span>
