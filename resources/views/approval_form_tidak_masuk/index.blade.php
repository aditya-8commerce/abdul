...
<div class="col-md-12 padding-0">
        <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Data Approval Tidak Masuk Kerja</h3> </div>
                    <div class="panel-body">
                      <div class="responsive-table">
                      <div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row">
					  <div class="col-sm-12">
					  <form class="cmxform" method="get" action="/persetujuan-form-tidak-masuk" novalidate="novalidate">
					 ...
					 <label> 
					  ...
					  <a href="/persetujuan-form-tidak-masuk"><input class="submit btn btn-danger" type="button" value="Reset"></a></label>
					  </div>
					  </form>
					  </div>
					  </div>
                      ...
                      <tr>
						  ...
						  <td><a href="/persetujuan-form-tidak-masuk/{{ Crypt::encrypt($absent->id) }}"><input class="submit btn btn-default" type="button" value="Lihat"></a> </td>
