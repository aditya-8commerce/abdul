...
<div class="col-md-12 panel">
	...
	<div class="col-md-12 panel-body" style="padding-bottom:30px;">
		<div class="col-md-12">
        <form class="cmxform" id="signupForm" method="post" enctype="multipart/form-data" action="/persetujuan-form-tidak-masuk/{{ Crypt::encrypt($data->id) }}" autocomplete="off">
        ...
        @csrf
			...
			<div class="col-md-12">
                <a href="/persetujuan-form-tidak-masuk"><input class="submit btn btn-primary" type="button" value="Kembali"></a>
            </div>
